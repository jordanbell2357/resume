...
### Key Skills
Documentation and Testing | SQL Data Pipeline Development | Time Series Analysis | Geospatial Data Analysis | Text Data Analytics | Discrete Optimization | Feature Engineering

### Languages
SQL (Hive, Spark, BigQuery) | Python | SAS | HTML, CSS, Markdown, Liquid, LaTeX | JavaScript | Expert Linux Bash/CLI for robust advanced text processing (sed/awk) and image manipulation (ImageMagick and ffmpeg)
...
NumPy | pandas | PySpark | Matplotlib | re, spaCy, nltk, sklearn.preprocessing, sklearn.feature_extraction.text (text processing and analysis) | automata-lib | sklearn.linear_model (linear and logistic regression) | scipy.spatial | statsmodels.tsa, pmdarima, sktime (time series analysis) | GeoPandas, Rasterio, xarray, h3, Cartopy (vector and raster geospatial data) | Pyomo and PuLP (constrained mixed integer programming optimization) | TensorFlow (image classification)
