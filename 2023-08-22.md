...
### Languages
SQL (Hive, Spark, BigQuery) | Python | SAS | HTML, CSS, Markdown, Liquid, LaTeX | JavaScript | Expert Linux Bash/CLI for robust advanced text processing (sed/awk) and image manipulation (Gnuplot, ImageMagick, Ghostscript, FFmpeg)
